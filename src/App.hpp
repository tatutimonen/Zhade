...
public:
    ...
    inline const auto& get_meshes() const noexcept { return m_meshes; }
    ...
    static constexpr auto name = "Shadow Mapper";
    static constexpr auto s_windowWidth = 800u;
    static constexpr auto s_windowHeight = 800u;
    static constexpr auto mouse_sensitivity = 0.002f;
