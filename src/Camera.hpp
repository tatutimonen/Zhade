...
class Camera : public Subject<Type::Observed::ViewProjection> {
public:
    struct Settings {
    ...
    inline void updateView()          { m_view = glm::lookAt(m_settings->center, m_settings->center + m_settings->target, m_settings->up); }
